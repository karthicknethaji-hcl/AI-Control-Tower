...
// Ported from Product-Studio-v9.37.01/proxy/lib/costTower/idempotency.js — same
// Supabase schema/RPCs, no logic changes.
//
...
// then a follow-up SELECT on an empty result — an empty result on conflict
